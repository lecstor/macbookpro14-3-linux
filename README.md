...
| Touch ID / Touch Bar | ⚠ A: **Touch ID enrolled + verified working** (`right-index-finger`; sudo, polkit and lock screen by touch, password fallback intact). Touch Bar still dark (`appletbdrm -110`) and cold boot still drops to `05ac:1281`. B: still `05ac:1281` | runbook route 3, 2026-09-18 entry; upstream t1-revive#7 + t1bridge#31 |
